...
description: >-
  Next.jsの静的ブログをS3 + CloudFrontにデプロイするCI/CDパイプラインを、Terraform + GitHub Actions
  OIDCで構築した記録。介護士がインフラを組んだ、詰まったところも含めて残す。
date: '2026-06-25'
tags:
  - aws
  - terraform
...
![CI/CDパイプラインのイメージイラスト](./thumbnail.png)
...
<RelatedPostCard slug="2026-06-26-cloudfront-403-url-rewrite" />
