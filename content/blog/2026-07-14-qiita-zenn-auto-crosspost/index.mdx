...
description: >-
  個人ブログの記事をQiitaとZennに自動でクロスポストする仕組みをGitHub Actionsで構築した記録。QiitaのREST
  APIとZennのGitHubリポジトリ連携という全く異なる仕組みの違いや、MDXのJSXコンポーネントが消える問題など、実装で詰まったポイントをまとめる。
date: '2026-07-14'
tags:
  - ci-cd
  - deploy
